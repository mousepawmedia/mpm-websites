...
<html>
<head>
	<title>Technologies — MousePaw Games</title>
	<meta name="Technologies" content="Discover the open source technologies that power MousePaw Games!" />
...
<body>
	<div class="page">
		...
		<div class="pagemain">
			<p class="txtHead1">Technologies</p>
			<p class="txtHead2">Why Open Source?</p>
			<a href="http://opensource.org/" target=_blank><img class="imgLeft imgSmall" src="/img/foss_logos/osi_logo.png"/></a>
			<p class="txtReg">
				Good ideas become great when we collaborate. The open
			...
			<p class="txtReg">
				...
				dedicated to promoting and contributing to this
				important revolution through our support of the
				<b><a href="http://opensource.org/" target=_blank>
					Open Source Initiative
				</a></b> and the projects that associate with it.
			</p>
			<p class="txtReg">
				Our company is fueled by open-source software! Check
				out the projects we use, and consider helping them
				stay alive and growing. Promoting these projects,
				contributing your knowledge and skills to them, and if
				possible, donating to them, helps keep this dream alive.
			</p>
			<p class="txtReg">
				Check out the following projects, all of which have
				become an essential part of MousePaw Games!
			</p>
			<hr/>
			<table class="tablemain"><tr>
				<td class="colHalf">
					<img class="imgCenter" src="/img/foss_logos/ubuntu_logo.png", alt="Ubuntu"/>
					<p class="txtReg">
						The official operating system of MousePaw
						Games. Ubuntu is one of the leading versions
						of Linux. Stable, powerful, and virus-free,
						Ubuntu is a fantastic option for any computer
						user, whether you're checking email, playing
						games, creating music, writing code, or
						running a server. Besides that, it is
						completely free.
					</p>
					...
					<p class="txtReg">
						...
						flowcharts, equations, LibreOffice does it all!
						More than just a free alternative to Microsoft
						Office, LibreOffice boasts some innovations of
						its own, all in a familiar interface. Besides
						that, it works on all major operating systems,
						and is compatible with just about any office
						document format imaginable.
					</p>
					...
					<p class="txtReg">
						...
						working with C++. Despite all of the dozens of
						useful programming tools, it has a
						straight-forward interface that puts the
						proprietary competition to shame. The various
						wizards allow for quick and reliable creation
						of projects, files, classes, and more.
						Code::Blocks supports C++, C, and Fortran.
					</p>
					...
					<p class="txtReg">
						...
						beats Python. For programming in Python,
						nothing beats NINJA-IDE. Hailed by Lead
						Developer Jason C. McDonald as “the single
						best IDE in the history of computing,” NINJA-IDE
						offers superb error and standard-style checking
						as you write, and ensures all of your code works
						in both Python 2 and Python 3. The only downside
						is that NINJA-IDE isn't available for other
					...
					<p class="txtReg">
						...
						place on Phabricator. This open source collection
						of web applications by Phacility provides
						complete bug and task tracking, pre- and
						post-commit review, a full-featured wiki, and
				...
				<td class="colHalf">
					...
					<p class="txtReg">
						Synfig Studio is regarded as one of the leading
						vector animation applications in the open-source
						community, and for good reason. Its powerful
						animation tools make it possible to create
						amazing things very quickly. While we do most
						animation in our own platform, we regard the
						Synfig Studio project as Lightrift's big sister.
					</p>
					...
					<p class="txtReg">
						...
						photo editing in the drawing world. Boasting
						an impressive tool set, and a large community
						of users, it rivals the top proprietary photo
						software on every front.
					</p>
					...
					<p class="txtReg">
						...
						paying for feature-heavy software costing in
						the thousands. Blender seeks to change all that
						by offering studio-quality CGI tools in an
						open-source software package. Some pretty
						impressive stuff has been created with it,
						including three award-winning short films.
					</p>
					...
					<p class="txtReg">
						...
						mean a clunky interface. Sporting a shallow
						learning curve, Inkscape puts all the tools
						you could need for vector-based drawing at
						your fingertips, without you having to go
					...
					<p class="txtReg">
						...
						long been regarded as one of the best. With a
						simple interface and dozens of studio-quality
						filters, it is easy to create high quality
						mixes very quickly, and export to several
						common formats. In our own tests, we found
						that its audio cleaning tool outperformed its
					...
					<p class="txtReg">
						...
						often, we need the operating system from those
						other guys too, especially when it comes to
						testing. This is where VirtualBox comes in
						handy. A free and open-source project managed
						by Oracle, VirtualBox makes it easy to run any
						operating system inside of another, as well as
						to control every aspect of the virtual system.
						Enough said.
					</p>
					<p class="txtHead3 txtForceWrap"><a href="https://www.virtualbox.org/", target=_blank>www.virtualbox.org</a></p>
				</td>
			</tr></table>
			<hr/>
