...
<html>
<head>
	<title>Stormsound — MousePaw Games</title>
	<meta name="Stormsound" content="High performance sound playback." />
	...
	<div class="page">
		...
		<div class="pagemain">
			<table class="tablemain">
				<tr>
					<td class="colNarrow">
						<img class="imgFull" src="/img/project_logos/stormsound_weblogo.png" alt="Stormsound"/>
					...
					<td class="colWide">
						<p class="txtHead1">Stormsound: High Performance Sound</p>
						...
						<div class="expander" tabindex=-1>
							<p class="txtReg"><b>
								Can I help with building Stormsound?
							</b></p>
						...
						<div class="expander" tabindex=-1>
							...
							<div class="hiddenDiv"><p class="txtReg">
								Stormsound is licensed under the
						...
						<div class="expander" tabindex=-1>
							<p class="txtReg"><b>
								Where can I download Stormsound?
							</b></p>
							<div class="hiddenDiv"><p class="txtReg">
